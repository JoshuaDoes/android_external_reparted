...
adb shell umount /mnt/ramdisk
adb shell mkdir -p /mnt/ramdisk
adb shell mount -t ramfs -o size=1M ramfs /mnt/ramdisk
...
adb push bin /mnt/ramdisk/reparted/
adb push reparted.json /mnt/ramdisk/reparted/
